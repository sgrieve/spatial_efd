...
def saveShapefile(filename, shpinstance, prj=None, epsg=None):
    '''
    ...
    Args:
        ...
        epsg (int): An epsg code referring to the spatial reference of the input
            data.

    Warning:
        If both a prj file and an epsg code are passed in the prj file takes
        precedence, to minimise the need for http queries.
    ...
    if prj:
        ...
        # we have been given an epsg code
        pass
