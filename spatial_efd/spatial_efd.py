...
def plotComparison(ax, coeffs, harmonic, x, y, rotation=0., color1='k',
    ...
    Args:
        ...
        harmonics (int): The number of harmonics to be used to generate coordinates. Must be <= coeffs.shape[0]. Supply a smaller value to produce coordinates for a more generalized shape.
